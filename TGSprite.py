...
class TGSprite:
    ...
    def group_as_sprite(self, canvas_item_list:list[TGCanvasItem], sprite_anchor:vector2d=vector2d(0,0)):
    ...
    def load_sprite(self, file_path_with_file_name:str, canvas:TGCanvas):
        ...
        with open(file_path_with_file_name, "r") as openfile:
            ...
            for canvas_item_data in json_object:
                canvas_item = TGCanvasItem(canvas, "json" + canvas_item_data.get("item_type"), canvas_item_data)
