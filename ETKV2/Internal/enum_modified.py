...
class EnumType(type):
    ...
    def __prepare__(metacls, cls, bases, **kwds):
        ...
        #metacls._check_for_existing_members_(cls, bases) #NOTE
...
class Enum(metaclass=EnumType):
    ...
    def _generate_next_value_(name, start, count, last_values):
        ...
        """
        global global_auto_counter
        global_auto_counter += 1
        return f"{name}_{start+count}_{global_auto_counter-1}" #NOTE
